...
- **FR-006**: Performance under load MUST remain within [NEEDS CLARIFICATION: specify concurrency/latency targets]
- **FR-007**: Accessibility MUST cover [NEEDS CLARIFICATION: define specific WCAG success criteria or assistive tech support]
