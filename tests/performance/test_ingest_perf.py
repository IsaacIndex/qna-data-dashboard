...
def test_upload_and_reembed_latency(storage: IngestStorage, benchmark: pytest.BenchmarkFixture) -> None:
    ...
    assert duration < MAX_UPLOAD_AND_ENQUEUE_SECONDS, f"Upload + enqueue exceeded budget: {duration}"
